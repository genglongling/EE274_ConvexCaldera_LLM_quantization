...
def main():
    ...
    tokenizer, model = load_llama2_13b(args.model_name, device=args.device)
    ...
    if args.output_dir is not None:
        ...
        if args.method == "scalar_uniform":
            save_dir = "./llama2_13b_scl_scalar8"
        elif args.method == "lloyd_max":
            save_dir = "./llama2_13b_scl_lloyd8"
        else:  # vector_vq
            save_dir = "./llama2_13b_scl_vq8"
